...
# ── Load model ────────────────────────────────────────────────────────────────
with open("desicion_tree.pkl", "rb") as f:
    model = pickle.load(f)
...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .btn:hover  { opacity: .9; transform: translateY(-1px); box-shadow: 0 12px 32px rgba(108,99,255,.45); }
...
<div class="header">
  ...
  <p>Fill in patient details below to get an instant survival prediction powered by a Decision Tree model.</p>
</div>
